...
export function LoginForm({ className, ...props }: { className?: string } & React.HTMLAttributes<HTMLDivElement>) {
  ...
  return (
    <div className={cn('flex flex-col gap-6', className)} {...props}>
      <Card className='bg-foreground p-5 font-secondary text-background'>
        <CardHeader className='text-center'>
          <CardTitle className='mb-5 text-xl'>Connexion</CardTitle>
        </CardHeader>
        <CardContent>
          <div className='grid gap-6'>
            ...
            <div className='flex flex-col gap-4'>
              ...
              <Button type='button' variant='connexion' className='w-full' onClick={() => handleSignIn('google')}>
                <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' className='mr-2 h-4 w-4'>
                  <path
