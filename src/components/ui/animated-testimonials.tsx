        ...
        <div className="relative min-h-[300px] sm:min-h-[400px] md:min-h-[500px]">
          <AnimatePresence>
            {members.map((member, index) => (
              ...
              >
                <Image
                  src={member.image || '/images/default/leader.avif'}
...
const description: Record<string, string> = {
  ...
  [MemberRole.Correspondant]:
    "Emails, licences, événements, planification des matchs et réservations des terrains : ça se passe ici. Si vous avez une question, j'ai sûrement la réponse, mais cherchez-la d'abord.",
  [MemberRole.Coach]:
