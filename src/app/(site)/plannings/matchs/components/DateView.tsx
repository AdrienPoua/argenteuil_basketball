...
const Card = ({
  ...
  return (
    <div className='group mx-auto max-w-screen-lg cursor-pointer overflow-hidden rounded-lg border border-primary bg-background shadow-md transition-all duration-200 hover:scale-105 hover:border-foreground hover:bg-primary hover:shadow-lg'>
