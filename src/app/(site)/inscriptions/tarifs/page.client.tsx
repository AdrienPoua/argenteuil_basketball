    ...
    <div className="relative px-4 sm:px-6 lg:px-8">
      ...
      <div className="custom-gradient-tertiary relative mb-8 overflow-hidden rounded-xl p-6 sm:mb-12 sm:rounded-2xl sm:p-8">
        <div className="relative z-10 space-y-2 sm:space-y-3">
          <p className="text-sm text-gray-600 sm:text-lg">💡 L&apos; assurance A est incluse dans le tarif de la licence.</p>
          <p className="text-sm text-gray-600 sm:text-lg">
            💡 En plus du montant de la licence, les adultes qui travaillent peuvent prendre l&apos;option B à 6,27€ ou B+C à
            6.63€
          </p>
          <p className="text-sm text-gray-600 sm:text-lg">
