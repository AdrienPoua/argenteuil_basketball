...
export const TarifCard = ({ tarif, index }: Readonly<PropsType>) => {
  ...
  return (
    <div
      className={`animate-fade-in-up group relative transform overflow-hidden rounded-xl border border-orange-200 bg-gradient-to-br from-white to-orange-50 shadow-lg transition-all duration-300 hover:-translate-y-2 hover:shadow-xl`}
