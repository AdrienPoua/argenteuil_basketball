    ...
    content={
      <ul className="flex flex-col gap-2">
        ...
        <li>
          ...
          <a href={'/documents/2024-2025_demande_de_licence.pdf'} download className="mx-2 text-primary hover:underline focus:outline-none focus:ring-2 focus:ring-primary">
            ici
          </a>
