...
const initialState = {
  ...
  job: '',
  image: '',
  isEmailDisplayed: true, // par défaut, l'email est affiché
  isNumberDisplayed: true // par défaut, le numéro est affiché
}
    ...
    >
      ...
      <div className="flex flex-col">
        ...
        <input
          ...
          value={payload.teams}
          onChange={(e) => setPayload({ ...payload, teams: e.target.value.split(" ") })}
          className="text-black"
        />
      </div>
