...
type getRencontresParPouleType = Awaited<
  ReturnType<typeof getRencontresParPoules>
>;
...
export type updateMatchsType = (
  matchs: getRencontresParPouleType,
  competitions: getCompetitionsType,
) => Promise<void>;
